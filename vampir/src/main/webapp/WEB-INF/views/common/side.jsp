...
<body>
  <div class="sidebar">
    <div class="subcategory" id="c1">
      <h3>DB</h3>
      <ul><li><a href="#">아이템 DB</a></li><li><a href="#">형상/탈것 DB</a></li><li><a href="#">몬스터 DB</a></li><li><a href="#">맵 DB</a></li><li><a href="#">내실 DB</a></li></ul>
    </div>
    ...
    <div class="subcategory" id="c3">
      <h3>새소식</h3>
      <ul><li><a href="#">공지사항</a></li><li><a href="#">업데이트</a></li><li><a href="#">개발자노트</a></li></ul>
    </div>
    <div class="subcategory" id="c4">
      <h3>고객센터</h3>
      <ul><li><a href="#">자주묻는질문</a></li><li><a href="#">1:1 문의</a></li></ul>
    </div>
  </div>
