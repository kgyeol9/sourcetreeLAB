...
<c:set var="pageActive" value="form"/> <%-- 활성 탭 --%>
<%@ page session="false"%>
<%
...
.thead, .r{ display:grid; grid-template-columns:1.1fr 1fr 1fr 1fr; } /* 이름 / 보유효과 / 연결효과 / 초월효과 */
...
<main class="db-main">
  ...
  <!-- 필터 -->
  <section class="card filters" aria-label="피의 형상 필터">
      ...
      <div class="fbox" id="filterBox">
        ...
        <div class="subrow">
          ...
          <div class="searchline">
            <input type="text" id="qTop" placeholder="형상 이름으로 검색" />
  ...
  <!-- 리스트 뷰 -->
  <section class="card list" id="listView" aria-label="피의 형상 목록">
    <div class="thead">
        ...
        <div class="detail">
          <div class="detail-inner">
            ...
            <c:if test="${not empty item.job}">
              <div class="subsec"><h4>직업</h4><div class="meta">${fn:escapeXml(item.job)}</div></div>
            </c:if>
  ...
  <!-- 카드 뷰 -->
  <section class="card" id="cardView" aria-label="피의 형상 카드 목록" style="display:none;">
  ...
  <section class="card footerbar" aria-label="페이징/검색">
    <div class="footerline footer-two">
      ...
      <div class="searchline">
        <input type="text" id="qBottom" placeholder="형상 이름으로 검색" />
...
<!-- 공용 스크립트: 기존 itemDB.js 재사용해도 기본 토글/검색 버튼 정도는 동작 -->
