...
public class BoardControllerImpl implements BoardController {
    ...
    public ResponseEntity<String> add(@RequestBody CommentVO comment, HttpSession session) throws Exception {
        ...
        // ✅ 로그인 안 되어 있으면 경고 메시지
        if (member == null) {
            return new ResponseEntity<String>("댓글을 작성하려면 로그인해야 합니다.", HttpStatus.UNAUTHORIZED);
        }
    ...
    public ResponseEntity<String> updateComment(
        ...
        boardService.updateComment(id, member.getMemCode(), content);
        return new ResponseEntity<String>("success", HttpStatus.OK);
    }
    ...
    public Map<String, Object> uploadImage(
        ...
        // URL 반환
        String fileUrl = request.getContextPath() + "/resources/upload/" + savedFileName;
